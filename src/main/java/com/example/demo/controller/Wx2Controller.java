...
/**
 * Created by gmg on on 2018-01-15 15:02.
 */
@RestController
@CrossOrigin
public class Wx2Controller {
        ...
        public Map<String, String> getWechatParam(String url){
            ...
            if(accessToken==null||(now - getTokenTime > tokenExpireTime*1000)){
            ...
            if(jsApiTicket==null||(now - getTiketTime > ticketExpireTime*1000)){
